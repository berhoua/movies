  ...
  <div class="s006">
    <form method="post" action="moviesresults.php" id="searchsubmit">
      <div id="dontfuck" class="switchform">
        ...
        <fieldset>
            <legend>Watch any Movie for free</legend>
            <p class="text-center sublegend">Just enter the name of the movie you want and click Search Now button to get it for free</p>
